            ...
            {isDesktop ? (
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs leading-relaxed text-text-muted">
                  Built from approved reports only — a draft or a rejected run is never
                  indexed, which is what makes a cited answer here worth trusting.
                </p>
            ...
            {runsLoading ? (
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs leading-relaxed text-text-muted">
                  ...
                  {runs.length === 1 ? "" : "s"} — not a project total.
                </p>
              </div>
            )}
          </div>
